...
public class Drivetrain extends SubsystemBase {
    ...
    private double d_kP = Constants.SwerveConstants.d_kP;
    private double d_kI = Constants.SwerveConstants.d_kI;
    private double d_kD = Constants.SwerveConstants.d_kD;
    private double d_kIz = Constants.SwerveConstants.d_kIz;
    private double d_kFF = Constants.SwerveConstants.d_kFF;
    private double d_kMaxOutput = Constants.SwerveConstants.d_kMaxOutput;
    private double d_kMinOutput = Constants.SwerveConstants.d_kMinOutput;
    ...
    private double s_kP = Constants.SwerveConstants.s_kP;
    private double s_kI = Constants.SwerveConstants.s_kI;
    private double s_kD = Constants.SwerveConstants.s_kD;
    private double s_kIz = Constants.SwerveConstants.s_kIz;
    private double s_kFF = Constants.SwerveConstants.s_kFF;
    private double s_kMaxOutput = Constants.SwerveConstants.s_kMaxOutput;
    private double s_kMinOutput = Constants.SwerveConstants.s_kMinOutput;
